# CS-255
Systems Analysis &amp; Design - SNHU

# Briefly summarize the DriverPass project. Who was the client? What type of system did they want you to design?
The DriverPass project is a project led by Liam, which aims to improve the passing rate of driving students at the local DMV. The system we are designing will be a web-based application that includes online courses and training for students as well as a scheduling tool to book driving classes with DriverPass. 

# What did you do particularly well?
I focused on the needs that were identified by Liam and Ian, to ensure the system would benefit the student drivers and fit the DriverPass teams mission.

# If you could choose one part of your work on these documents to revise, what would you pick? How would you improve it?
I would improve the Gant Chart included at the end to make it easier to read. It was meant to give a simple visual of the development schedule, but it doesn't help if it's hard to follow. 
